...
Every image in `examples/` ships with the MP4 the CLI produced from it. The photosynthesis scenes were generated by Kinoslide for a lecture; the other two are standalone images.
